...
const float ANGLE_LIMIT = 5 * DEG_TO_RAD;
...
const byte SENSOR_CHAN[3] = { 3 , 2 , 6 };  
...
const byte PIN_Y_IN1 = 25;
const byte PIN_Y_IN2 = 26;
const byte PIN_Y_IN3 = 27;

const byte PIN_Z_IN1 = 18;
const byte PIN_Z_IN2 = 17;
const byte PIN_Z_IN3 = 5;

const byte PIN_X_IN1 = 16;
const byte PIN_X_IN2 = 15;
const byte PIN_X_IN3 = 2;

// Power
const float BATTERY_VOLTAGE = 11.1;
const float VOLTAGE_LIMIT = 6.0;
