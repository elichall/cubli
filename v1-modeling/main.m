...
disp(Ke_min)
% K is the gain matrix, P is the solution to the algebraic Riccati equation, and E are the closed-loop poles.


%% root locus analysis
sys = ss(Ae_min, Be_min, eye(4), zeros(4,1));
% closed loop system
sys_cl = ss(Ae_min - Be_min * Ke_min, Be_min, eye(4), zeros(4,1));

rlocusplot(sys_cl(1,1))